var crudApp = new function () {
                ...
                if (j == 2) {   // WE'LL ADD A DROPDOWN LIST AT THE SECOND COLUMN (FOR Transacción).
                    ...
                    for (k = 0; k < this.Transacción.length; k++) {
                        select.innerHTML = select.innerHTML +
                            '<option value="' + this.Transacción[k] + '">' + this.Transacción[k] + '</option>';
                    }
                    newCell.appendChild(select);
                }
                else{

                    if (j == 1) {   // WE'LL ADD A DROPDOWN LIST AT THE SECOND COLUMN (FOR Producto).
    ...
    this.Cancel = function (oButton) {
        ...
        for (i = 0; i < this.col.length; i++) {
            ...
            td.innerHTML = this.myInventarios[(activeRow - 1)][this.col[i]];
        }
    }
